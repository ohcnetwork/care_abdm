...
from care_abdm.api.viewsets.abha_number import AbhaNumberViewSet
from care_abdm.api.viewsets.auth import (
    AuthNotifyView,
    DiscoverView,
    LinkConfirmView,
    LinkInitView,
...
from care_abdm.api.viewsets.consent import ConsentCallbackViewSet, ConsentViewSet
from care_abdm.api.viewsets.health_facility import HealthFacilityViewSet
from care_abdm.api.viewsets.health_information import (
    HealthInformationCallbackViewSet,
    HealthInformationViewSet,
)
from care_abdm.api.viewsets.healthid import ABDMHealthIDViewSet
from care_abdm.api.viewsets.hip import HipViewSet
from care_abdm.api.viewsets.monitoring import HeartbeatView
from care_abdm.api.viewsets.patients import PatientsCallbackViewSet, PatientsViewSet
from care_abdm.api.viewsets.status import NotifyView as PatientStatusNotifyView
from care_abdm.api.viewsets.status import SMSOnNotifyView
